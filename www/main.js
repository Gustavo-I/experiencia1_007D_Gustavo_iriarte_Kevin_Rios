...
const routes = [
    ...
    {
        path: 'noticias',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_noticias_noticias_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/noticias/noticias.module */ 9623)).then(m => m.NoticiasPageModule)
    },
    {
        path: 'suscripcion',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_suscripcion_suscripcion_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/suscripcion/suscripcion.module */ 9086)).then(m => m.SuscripcionPageModule)
    },
    {
        path: 'details',
